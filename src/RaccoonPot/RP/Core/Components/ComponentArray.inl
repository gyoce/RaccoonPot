...
namespace RP {
    ...
    template<class T>
    void ComponentArray<T>::updateMapToMovedSpot(const size_t indexOfRemovedEntity, const size_t indexOfLastElement) {
    ...
    template<class T>
    void ComponentArray<T>::putNewEntryAtTheEnd(const Entity entity, T component) {
